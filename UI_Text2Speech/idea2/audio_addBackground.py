...
main_audio_path = os.path.join(current_dir, "idea2_final.mp3")
background_path = os.path.join(current_dir, "coffee_background.mp3")
output_path = os.path.join(current_dir, "idea2_final_mix.mp3")
...
background = background.volumex(0.75)
