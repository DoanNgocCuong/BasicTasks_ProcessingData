...
text_to_speech("""
Nếu bạn chọn câu trả lời số 1 'Just one, please. Table for one.' hoặc số 2 'Two people, please.', thì đây là lựa chọn đúng cho câu hỏi của nhân viên phục vụ. Câu trả lời số 3 không phù hợp vì không liên quan đến số lượng người."
""", output_file="1.mp3")